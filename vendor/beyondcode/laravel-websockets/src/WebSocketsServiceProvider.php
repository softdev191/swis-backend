...
class WebSocketsServiceProvider extends ServiceProvider
{
    ...
    protected function registerRoutes()
    {
        app('router')->group([
            ...
            app('router')->get('/api/{appId}/statistics', 'BeyondCode\LaravelWebSockets\Dashboard\Http\Controllers\DashboardApiController@getStatistics');
            ...
            app('router')->group(['middleware' => AuthorizeStatistics::class], function () {
                app('router')->post('statistics', 'BeyondCode\LaravelWebSockets\Statistics\Http\Controllers\WebSocketStatisticsEntriesController@store');
            });
        });
